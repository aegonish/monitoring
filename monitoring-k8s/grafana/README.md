# grafana
This folder is a minimal kustomize-safe placeholder for the grafana component.
It creates:
- Namespace: monitoring-grafana
- A ConfigMap `grafana-values` in that namespace as a placeholder for Helm values or kustomize overlays.
