# promtail
This folder is a minimal kustomize-safe placeholder for the promtail component.
It creates:
- Namespace: monitoring-promtail
- A ConfigMap `promtail-values` in that namespace as a placeholder for Helm values or kustomize overlays.
