# loki
This folder is a minimal kustomize-safe placeholder for the loki component.
It creates:
- Namespace: monitoring-loki
- A ConfigMap `loki-values` in that namespace as a placeholder for Helm values or kustomize overlays.
