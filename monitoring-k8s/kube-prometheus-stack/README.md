...
This folder is a minimal kustomize-safe placeholder for the kube-prometheus-stack component.
It creates:
- Namespace: monitoring-kube-prometheus-stack
- A ConfigMap `kube-prometheus-stack-values` in that namespace as a placeholder for Helm values or kustomize overlays.
